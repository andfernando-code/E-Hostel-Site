        ...
        <div class="containerss">
            <div class="box form-box">
              ...
              if(isset($_POST['submit'])){
                ...
                $result = mysqli_query($con,"SELECT * FROM warden WHERE email='$email' AND password='$password' ") or die("Select Error");
                ...
                if(is_array($row) && !empty($row)){
                    ...
                    echo '  window.location.href = "logwarden.php";';  
                    echo '} else {';
                    echo '}';
                    echo '</script>';
                ...
                <div class="msgBanner">
                    <div class="mb-5 mb-lg-0">
                        <h1 class="my-5 display-3 fw-bold ls-tight">
                            Login<br />
                            <span>for warden in the Web</span>
                        </h1>
                        <p style="color: hsl(217, 10%, 50.8%)">
                            The warden can view all the advertisements, validate by looking at
                            the uploaded photo(s), and approve or reject stating a reason
                        </p>
                    </div>
                </div>
