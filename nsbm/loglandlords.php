        ...
        <div class="containerss">
            <div class="box form-box">
              ...
              if(isset($_POST['submit'])){
                ...
                $result = mysqli_query($con,"SELECT * FROM landlords WHERE email='$email' AND password='$password' ") or die("Select Error");
            ...
            ?>
                ...
                <form action="" method="post">
                    ...
                    <div class="links">
                        Don't have account? <a href="./reglandlords.php">SignUp</a>
                    </div>
