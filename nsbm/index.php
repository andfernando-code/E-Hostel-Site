                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 700px">
                                ...
                                <h1 class="display-3 text-white mb-4 animated slideInDown">
                                    Find Suitable Place For You
                                </h1>
                                <a href="./room.php"
                                    class="btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">browser Rooms</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row g-5 align-items-center">
                        ...
                        <div class="row g-3">
                            <div class="col-6 text-end">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.1s"
                                    src="img/room (2).jpg" style="margin-top: 25%" />
                            </div>
                    ...
                    <div class="col-lg-6">
                        <h1 class="mb-4">
                            Welcome to the
                            <span class=" text-uppercase">UNILODGE</span>
                        </h1>
                        <p class="mb-4">
                        Under the direction of the new warden, NSBM Green University intends to develop a website to assist new students in finding housing on campus.
                            ...
                            <div class="col-sm-4 wow fadeIn" data-wow-delay="0.5s">
                                <div class="border rounded p-1">
                                    <div class="border rounded text-center p-4">
                                        ...
                                        <h2 class="mb-1">309</h2>
                                        <p class="mb-0">Students</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <a class="btn-primary py-3 px-5 mt-2" href="#upperratings">Explore More</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container-xxl py-5">
            <div class="container" id="upperratings">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="mb-5">
                        <span class="text-uppercase"> Trending </span>Rooms
                    </h1>
                </div>
                <div class="row g-4">
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between">
                                    <button class="btn btn-sm btn-primary rounded py-2 px-4 book" href=""
                                        data-value="2@gmail.com">Book</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="p-4 mt-2">
                                <div class="d-flex justify-content-between mb-3">
                                    <h5 class="mb-0">Nayomi Hostel</h5>
                                    <div class="ps-2">
                                        4.9 <small class="fa fa-star text-primary"></small>
                                    </div>
                                </div>
