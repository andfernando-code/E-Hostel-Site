...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div>
            <div style="margin: 20px;">
                ...
                <?php
                    ...
                    include_once './php/config.php';
                    $email = $_SESSION['valid'];
                    $result = mysqli_query($con,"SELECT * FROM srequest");
                    ?>
        ...
        <div style="margin: 20px;">
            <a class="btn">Registered Landlords </a>
            <!-- Page Header End -->
            <?php
                    
                    include_once './php/config.php';
                    $email = $_SESSION['valid'];
                    $result = mysqli_query($con,"SELECT * FROM landlords");
                    ?>
        ...
        <div style="margin: 20px;">
            <a class="btn">Registered Students </a>
            <!-- Page Header End -->
            <?php
        ...
        <div style="margin: 20px;">
            <a class="btn">Currently Warden </a>
            <!-- Page Header End -->
            <?php
        ...
        <div style="margin: 20px;">
            <a class="btn">Currently Web Admin </a>
            <!-- Page Header End -->
            <?php
                    
                    include_once './php/config.php';
                    $email = $_SESSION['valid'];
                    $result = mysqli_query($con,"SELECT * FROM webadmin");
                    ?>
