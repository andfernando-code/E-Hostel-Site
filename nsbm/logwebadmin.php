        ...
        <div class="containerss">
            <div class="box form-box">
              ...
              if(isset($_POST['submit'])){
                ...
                $result = mysqli_query($con,"SELECT * FROM webadmin WHERE email='$email' AND password='$password' ") or die("Select Error");
                ...
                if(is_array($row) && !empty($row)){
                    ...
                    echo '  window.location.href = "logwebadmin.php";';  
                    echo '} else {';
                    echo '}';
                    echo '</script>';
                }
                ...
                <div class="msgBanner">
                    <div class="mb-5 mb-lg-0">
                        <h1 class="my-5 display-3 fw-bold ls-tight">
                            Login <br />
                            <span>for Web Admin</span>
                        </h1>
                        <p style="color: hsl(217, 10%, 50.8%)">
                            Mange the all inquiry and inquisitive.
                        </p>
                    </div>
                </div>
